"""
Test Persian PDF generation with all fixes
"""
import sys
...
# Test data
test_data = {
    "analysis_id": "test_final_123",
    "timestamp": "2024-01-15 10:30:00",
    "user_id": "arj mahsa",
    "profile_context": {
        "age": 22,
        "skin_type": "oily",
        "medical_history": ["l", "a", "t", "e", "x"],  # Should be converted to "latex"
        "allergies": ["None"]
    },
    "model": {
        "name": "PanDerm",
...
print("Generating Persian PDF with all fixes...")
